...
export const ProductProcedure = () => {
  return (
    <div className={Styles.procedureFeather}>
      <Image src={prodceduretop} alt="" className={Styles.prodceduretop} />
      <Image src={procedureright} alt="" className={Styles.prodcedureright} />
      <Image src={procedurebottom} alt="" className={Styles.prodcedurebottom} />

      <div className={Styles.productProcedureContainer}>
        <div className={Styles.procedureSpacing}>
          <Heading
